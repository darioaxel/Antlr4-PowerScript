...
grammar PSbasics_Header;

// starting point for parsing a PowerScript file

compilationUnit
    : headerDeclaration* EOF 
    | typeDeclaration* EOF
    ;

headerDeclaration 
	: headerExportDeclaration headerExportCommentDeclaration*              
	;

headerExportDeclaration
	:  EXPORTHEADER (StringLiteral'.'StringLiteral)* delimiter  
	;

headerExportCommentDeclaration
	: EXPORTHEADERCOMMENT StringLiteral* delimiter                  
	;
